...
```html
<link href="https://cdn.jsdelivr.net/gh/mshafer1/quick-filter-table@1.1.1/quick-filter-table/dist/quick-filter-table.css" rel="stylesheet" />
...
<details>
    ...
    <script type="module">
        ...
        createPlayground('#container-1', {
            params: {
                scripts: [
                    'https://cdn.jsdelivr.net/gh/mshafer1/quick-filter-table@1.1.1/quick-filter-table/dist/quick-filter-table.js',
                ],
                stylesheets: [
                    'https://cdn.jsdelivr.net/gh/mshafer1/quick-filter-table@1.1.1/quick-filter-table/dist/quick-filter-table.css',
                ],
